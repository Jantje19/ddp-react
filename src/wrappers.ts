...
export const mainThreadWrapper = (
	client: Worker | simpleDDP
): MainThreadWorkerWrapper | MainThreadWrapper => {
	...
	throw new Error(
		"Invalid 'client' argument passed to 'mainThreadWrapper'. Expected an instance of 'Worker' or 'simpleDDP'."
	);
};

export const workerWrapper = (client: simpleDDP) => {
